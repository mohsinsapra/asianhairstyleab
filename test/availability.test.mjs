...
const cut   = findService('dam-kort');    // 45 min, maxConcurrent 2
const ker   = findService('keratin');     // 360 min, maxConcurrent 1
const bal   = findService('balayage');    // 270 min, maxConcurrent 1
...
const oneCut = [{ start_min: 720, end_min: 765, service_id: 'dam-kort' }];
...
const twoCuts = [
  { start_min: 720, end_min: 765, service_id: 'dam-kort' },
  { start_min: 720, end_min: 765, service_id: 'dam-kort' },
];
...
const oneKeratin = [{ start_min: 600, end_min: 960, service_id: 'keratin' }];
...
const busy = [
  { start_min: 600, end_min: 960, service_id: 'keratin' },
  { start_min: 660, end_min: 705, service_id: 'dam-kort' },
];
...
const twoLong = [
  { start_min: 600, end_min: 960, service_id: 'keratin' },
  { start_min: 600, end_min: 870, service_id: 'balayage' },
];
